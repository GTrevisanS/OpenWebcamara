...
set "TESTEBANNER1=call Banners.txt"
call Config.bat
...
echo            WebCamara Cliente                  DIGITE...        [4]
...
:FLA
set "PYEXE=%MINHAPASTA%\Webcamara %VERSAO% (%EXECUTAVEL%)"
Goto FINAL
exit
:: ----------------------------------------------------------------------------
...
echo =============================================================================
echo.
echo                       WebCamara Cliente selecionado!
echo.
echo                            ABRINDO WEBCAMARA...
echo.
echo =============================================================================
echo.
timeout /t 2 /nobreak >nul
call SearchEXE.bat %PASTACLIENTE%
timeout /t 2 /nobreak >nul
Goto FINAL
exit
:: ----------------------------------------------------------------------------
